...
export type OperatorAuth =
  | { ok: true; userId: string | null; via: 'service_role' | 'operator' }
...
export async function authorizeOperator(req: Request, supabase: any, createClient: any): Promise<OperatorAuth> {
