...
UPDATE public.agency_agents SET capabilities = jsonb_build_object(
  'chat', jsonb_build_array('openrouter/owl-alpha','openrouter/deepseek/deepseek-v4-flash','openai/gpt-5'),
...
UPDATE public.agency_agents SET capabilities = jsonb_build_object(
  'chat', jsonb_build_array('openrouter/owl-alpha','openai/gpt-5')
